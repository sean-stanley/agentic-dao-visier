...
import type { SentinelTypes } from './sources/sentinel/types';
import * as importedModule$0 from "./sources/sentinel/introspectionSchema";
...
export type MeshContext = SentinelTypes.Context & BaseMeshContext;
...
const importFn: ImportFn = <T>(moduleId: string) => {
  ...
  switch(relativeModuleId) {
    case ".graphclient/sources/sentinel/introspectionSchema":
...
const sentinelTransforms = [];
const additionalTypeDefs = [] as any[];
const sentinelHandler = new GraphqlHandler({
              name: "sentinel",
              config: {"endpoint":"https://api.studio.thegraph.com/query/102988/daolens/version/latest"},
              baseDir,
              cache,
              pubsub,
              store: sourcesStore.child("sentinel"),
              logger: logger.child("sentinel"),
              importFn,
            });
sources[0] = {
          name: 'sentinel',
          handler: sentinelHandler,
          transforms: sentinelTransforms
        }
...
const documentHashMap = {
        "74cf6d8b99a025b03584dac1f971013b3c088822e588bd00072c94b6df826586": ExampleQueryDocument
      }
  ...
  return {
    ...
    get documents() {
      return [
      {
        ...
        sha256Hash: '74cf6d8b99a025b03584dac1f971013b3c088822e588bd00072c94b6df826586'
      }
    ];
    },
    fetchFn,
...
export type ExampleQueryQuery = { proposalSubmitteds: Array<Pick<ProposalSubmitted, 'id' | 'description' | 'descriptionHash' | 'expiryTimestamp' | 'proposal_id' | 'proposer' | 'vote_yes' | 'vote_no' | 'ai_risk_score'>> };
